#!/usr/bin/env python3
"""
Shortcut. The code lives in gtasa.weapons.py -- weapons and ammo.

    python weapons.py ...      is the same as      python -m gtasa.weapons ...
...
sys.exit(runpy.run_module("gtasa.weapons", run_name="__main__") and 0)
