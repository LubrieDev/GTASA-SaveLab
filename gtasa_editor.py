#!/usr/bin/env python3
"""
Shortcut. The code lives in gtasa.editor.py -- save editor (money, progress).

    python gtasa_editor.py ...      is the same as      python -m gtasa.editor ...
...
sys.exit(runpy.run_module("gtasa.editor", run_name="__main__") and 0)
