#!/usr/bin/env python3
"""
Shortcut. The code lives in gtasa.wardrobe.py -- clothing.

    python wardrobe.py ...      is the same as      python -m gtasa.wardrobe ...
...
sys.exit(runpy.run_module("gtasa.wardrobe", run_name="__main__") and 0)
