#!/usr/bin/env python3
"""
Shortcut. The code lives in gtasa.globals.py -- main.scm global variables.

    python globals.py ...      is the same as      python -m gtasa.globals ...
...
sys.exit(runpy.run_module("gtasa.globals", run_name="__main__") and 0)
