#!/usr/bin/env python3
"""
Shortcut. The code lives in gtasa.analisis.expedition.py -- chain differentials.

    python expedition.py ...      is the same as      python -m gtasa.analisis.expedition ...
...
sys.exit(runpy.run_module("gtasa.analisis.expedition", run_name="__main__") and 0)
