#!/usr/bin/env python3
"""
Shortcut. The code lives in gtasa.analisis.harvest.py -- cross-references stat transcripts.

    python harvest.py ...      is the same as      python -m gtasa.analisis.harvest ...
...
sys.exit(runpy.run_module("gtasa.analisis.harvest", run_name="__main__") and 0)
